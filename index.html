...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-center { text-align: center; margin-top: 20px; margin-bottom: 40px; }
        ...
        .card i { font-size: 2rem; color: var(--accent-cyan); margin-bottom: 15px; }
        ...
        .l-bronze { background: var(--bronze); color: white; }
        .l-silver { background: var(--silver); color: black; }
        .l-gold { background: var(--gold); color: black; }
...
<body>
    ...
    <h2 class="section-title" id="services" style="text-align:center; padding-top: 80px;">Choose Your <span>Service</span> Tier</h2>
    <section class="services-grid">
        ...
        <div class="card">
            ...
            <div class="tier-container">
                <div class="tier-item">
                    <span class="tier-label l-bronze">Bronze</span>
                    <p class="tier-desc">Single Landing Page, Basic SEO, Responsive Design.</p>
                </div>
                <div class="tier-item">
                    <span class="tier-label l-silver">Silver</span>
                    <p class="tier-desc">Multi-page Business Site (up to 5), Contact Forms, Speed Optimization.</p>
                </div>
                <div class="tier-item">
                    <span class="tier-label l-gold">Gold</span>
                    <p class="tier-desc">Full E-commerce, Premium Animations, 1 Month Free Support.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="tier-container">
                <div class="tier-item">
                    <span class="tier-label l-bronze">Bronze</span>
                    <p class="tier-desc">1 Concept, High-Res PNG/JPG, 2 Revisions.</p>
                </div>
                <div class="tier-item">
                    <span class="tier-label l-silver">Silver</span>
                    <p class="tier-desc">3 Concepts, Vector Files (AI/SVG), Social Media Kit.</p>
                </div>
                <div class="tier-item">
                    <span class="tier-label l-gold">Gold</span>
                    <p class="tier-desc">5 Concepts, Full Brand Guidelines, Stationery Designs, Unlimited Revisions.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="tier-container">
                <div class="tier-item">
                    <span class="tier-label l-bronze">Bronze</span>
                    <p class="tier-desc">1 Professional Thumbnail or Banner.</p>
                </div>
                <div class="tier-item">
                    <span class="tier-label l-silver">Silver</span>
                    <p class="tier-desc">3 Thumbnails + 1 Banner with Source Files.</p>
                </div>
                <div class="tier-item">
                    <span class="tier-label l-gold">Gold</span>
                    <p class="tier-desc">Monthly Pack: 10 Thumbnails, Profile Design, and VIP Branding.</p>
                </div>
            </div>
        </div>
    ...
    <section class="contact" id="contact">
        ...
        <div class="contact-container">
            <form action="https://formsubmit.co/ujawalsharma999@gmail.com" method="POST">
                ...
                <textarea name="message" rows="5" placeholder="Project Details & Chosen Tier (e.g. Website Silver)" required></textarea>
    ...
    <footer>
        <div class="logo">QAVE<span>XIN</span></div>
        <p>&copy; 2025 Qavexin India | Founder: Ujjawal Sharma</p>
        <p>qavexinofficial@gmail.com </p>
    </footer>
